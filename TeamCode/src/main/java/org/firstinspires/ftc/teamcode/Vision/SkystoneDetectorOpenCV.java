...
//    RobotHardware opmode;
    ...
    // Demo2
    public static int position = 0; // output position



    public SkystoneDetectorOpenCV(Color.Ftc teamColor) {
...
//       this.hardwareMap = opmode.hardwareMap;
    ...
    public void init() {
        ...
        webcam.setPipeline(new AveragingPipeline());
        // If the resolution specified is not supported by the camera, an error will be thrown.
        webcam.startStreaming(320, 240, OpenCvCameraRotation.UPRIGHT);
    }


    // Grab a instance of the pipeline for testing.
    // Pipeline is not static, retains access to state context.
    public AveragingPipeline testingPipeline;
    public AveragingPipeline getPipelineForTesting() {
        testingPipeline = new AveragingPipeline();
